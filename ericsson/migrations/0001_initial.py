# Generated by Django 2.0.13 on 2019-04-30 21:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Mode_of_Communication', models.CharField(blank=True, choices=[('Whatsapp', 'Whatsapp'), ('Primary Bridge', 'Primary Bridge'), ('Secondary Bridge', 'Secondary Bridge'), ('IM', 'IM'), ('E-Mail', 'E-Mail')], max_length=255)),
                ('Activity', models.CharField(blank=True, choices=[('C&I', 'C&I'), ('Troubleshoot', 'Troubleshoot'), ('LATP Testing', 'LATP Testing'), ('FATP Testing', 'FATP Testing'), ('Pre-Integration', 'Pre-Integration'), ('Update to FE', 'Update to FE')], max_length=255)),
                ('Activity_status', models.CharField(blank=True, choices=[('Open', 'Open'), ('Close', 'Close'), ('Handover', 'Handover')], max_length=255)),
                ...
                ('Alarms_Preventing_RET_Config', models.CharField(blank=True, default='', max_length=255)),
